"""Pipeline baseline: loops puros em Python."""
...
from experiments.baseline.preprocessing import process_images
...
def process_pipeline(
    ...
    (images_gray, images_edges), timings.preprocess_s = time_block(process_images, images_rgb)
