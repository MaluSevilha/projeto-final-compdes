"""Pipeline using Numba with parallel=True / prange."""
...
from experiments.numba_parallel.preprocessing import process_images, resolve_threads
...
def process_pipeline(
    ...
    (images_gray, images_edges), timings.preprocess_s = time_block(
        process_images, images_rgb, threads
    )
