...
from experiments.gpu.preprocessing import process_images_gpu
...
def process_pipeline(
    ...
    (images_gray, images_edges), timings.preprocess_s = time_block(process_images_gpu, images_rgb, device)

    timings.total_s = now_s() - total_start
    return PipelineResult(images_rgb, images_gray, images_edges, labels, timings, class_names, device)
